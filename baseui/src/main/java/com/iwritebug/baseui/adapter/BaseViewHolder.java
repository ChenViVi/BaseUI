...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setOnClickListener(int viewId, BaseAdapter.OnItemChildClickListener listener) {
        View view = getView(viewId);
    ...
    public BaseViewHolder setOnLongClickListener(int viewId, BaseAdapter.OnItemChildLongClickListener listener) {
        View view = getView(viewId);
        listener.mViewHolder = this;
        view.setOnLongClickListener(listener);
        return this;
